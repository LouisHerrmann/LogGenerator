    ...
    def start_simulation(self):
        ...
        while i < len(self.trace_simulations):
            if self.minimize_for_node_coverage and self.get_uncovered_nodes_coverage() == set():
                # in case all nodes have been covered, and we don't care about paths already, we stop
                break
...
if __name__ == '__main__':
    ...
    graph = """digraph { 0[label="BPMN_START"]; 2[label="BPMN_TASK(ClearCustomerInvoice):5739691"]; 1[label="BPMN_END"]; 3[label="BPMN_START"]; 5[label="BPMN_PARALLEL"]; 7[label="BPMN_EXCLUSIVE_CHOICE"]; 8[label="BPMN_TASK(EnterInvoiceWithoutSalesOrder):2062437"]; 6[label="BPMN_PARALLEL"]; 9[label="BPMN_TASK(CreateCustomerInvoice):1296652"]; 4[label="BPMN_END"]; 10[label="BPMN_START"]; 12[label="BPMN_PARALLEL"]; 14[label="BPMN_EXCLUSIVE_CHOICE"]; 15[label="BPMN_TASK(CreateDelivery):421211"]; 13[label="BPMN_PARALLEL"]; 16[label="BPMN_TASK(CreateSalesOrder):260688"]; 17[label="BPMN_PARALLEL"]; 18[label="BPMN_EXCLUSIVE_CHOICE"]; 19[label="BPMN_TASK(CreateSalesQuotation):12786"]; 20[label="BPMN_EXCLUSIVE_CHOICE"]; 21[label="BPMN_TASK(SetCreditHold):6790"]; 22[label="BPMN_TASK(SetBillingBlock):3028"]; 23[label="BPMN_TASK(RemoveBillingBlock):17425"]; 24[label="BPMN_EXCLUSIVE_CHOICE"]; 25[label="BPMN_TASK(SetDeliveryBlock):2302"]; 26[label="BPMN_TASK(RemoveDeliveryBlock):58850"]; 27[label="BPMN_TASK(PassCredit):7857"]; 11[label="BPMN_END"]; 0 -> 2 [object=0, label=5739691]; 2 -> 1 [object=0, label=5739691]; 3 -> 5 [object=1, label=3451856]; 5 -> 7 [object=1, label=3451856]; 7 -> 8 [object=1, label=10377724]; 8 -> 7 [object=1, label=10377724]; 7 -> 2 [object=1, label=5336778]; 2 -> 7 [object=1, label=5336778]; 7 -> 6 [object=1, label=3451856]; 5 -> 9 [object=1, label=3451856]; 9 -> 6 [object=1, label=3451856]; 6 -> 4 [object=1, label=3451856]; 10 -> 12 [object=2, label=260688]; 12 -> 14 [object=2, label=260688]; 14 -> 15 [object=2, label=282853]; 15 -> 14 [object=2, label=282853]; 14 -> 13 [object=2, label=260688]; 12 -> 16 [object=2, label=260688]; 16 -> 17 [object=2, label=260688]; 17 -> 18 [object=2, label=260688]; 18 -> 19 [object=2, label=281]; 19 -> 18 [object=2, label=281]; 18 -> 20 [object=2, label=260688]; 20 -> 21 [object=2, label=6790]; 21 -> 20 [object=2, label=6790]; 20 -> 22 [object=2, label=3028]; 22 -> 20 [object=2, label=3028]; 20 -> 23 [object=2, label=17425]; 23 -> 20 [object=2, label=17425]; 20 -> 13 [object=2, label=260688]; 17 -> 24 [object=2, label=260688]; 24 -> 25 [object=2, label=2302]; 25 -> 24 [object=2, label=2302]; 24 -> 26 [object=2, label=58850]; 26 -> 24 [object=2, label=58850]; 24 -> 27 [object=2, label=7857]; 27 -> 24 [object=2, label=7857]; 24 -> 9 [object=2, label=140136]; 9 -> 24 [object=2, label=140136]; 24 -> 13 [object=2, label=260688]; 13 -> 11 [object=2, label=260688];}"""
...
#            to_dot_format(graph, "output/0.dot")
        ...
        simulation = Simulation(graph, max_trace_length=50, max_cycles=2, minimize_for_node_coverage=True)
