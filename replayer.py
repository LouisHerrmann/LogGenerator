...
if __name__ == '__main__':
    ...
    for ot in object_types:
        ...
        if ot == "3":
            to_dot_format(graph, "output/3.dot")

        simulation = Simulation(graph, max_trace_length=100, max_cycles=2, minimize_for_node_coverage=True)
        ...
        print("Number of traces:", len(simulation.trace_simulations))
